...
unittest.suite('merchant')
        ...
        .test('makeUrl w/ keyword', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&keyword="foo"');
        })
        .test('makeUrl w/ category', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&cat="foo"');
        })
        .test('makeUrl w/ results', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&MaxResults=1');
        })
        .test('makeUrl w/ page', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&pagenumber=1');
        })
        .test('makeUrl w/ mid', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&mid=1');
        })
        .test('makeUrl w/ sort', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&sort=foo&sorttype=asc');
        })
        .test('makeUrl w/ sort & sorttype', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&sort=foo&sorttype=desc');
        })
        .test('makeUrl w/ multiple sort & sorttype', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&sort=foo&sorttype=asc&sort=bar&sorttype=desc');
        })
        .test('makeUrl w/ mismatched sort & sorttype', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&sort=foo&sorttype=desc&sort=bar&sorttype=asc');
        })
        .test('makeUrl w/ compound', function (test, fixture) {
        	...
        	test.equal(result, fixture.urls.merchantPath + '?token=abc&keyword="foo"&cat="bar"&MaxResults=10&pagenumber=5&mid=6&sort=baz&sorttype=desc&sort=boo&sorttype=asc');
        })
        ;